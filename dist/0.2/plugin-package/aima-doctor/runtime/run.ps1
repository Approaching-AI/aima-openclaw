...
$script:ApiBaseUrl = 'https://aimaservice.ai/platform/api/v1'
...
$script:DoctorDir = Join-Path $env:USERPROFILE ".openclaw\tools\aima-doctor"
...
$script:RunMode = "run"        # packaged runtime executes immediately
